##This is called type hinting tells us the input for the function should be a list and return a float
...
class Book:
    ...
    @classmethod
    def hardcover(cls, name: str, page_weight: int) -> "Book":##Used to say that you are returning a type of the class youre currently in
