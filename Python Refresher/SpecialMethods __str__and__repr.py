...
bob = Person("Bob", 35)
print(bob)  # Not the nicest thing to read! prints out the representation of the object
...
class Person:
    def __init__(self, name, age):
        self.name = name
        self.age = age
    ##Changes the print out representation of the object
    def __str__(self):
...
class Person:
    ...
    def __repr__(self):
        ...
        )  # d!r calls the __repr__ method of the thing.
